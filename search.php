  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <div class="input-group">
        <input type="text" name="search" class="form-control" placeholder="Search for jewelry Products...">
      ...
      <ul class="nav navbar-nav navbar-right" id="glyphicon-text">
            ...
            <a href="wishlist.php" title="wishlist"><i class="glyphicon glyphicon-heart" id="glyphicon-heart"></i>WishList</a>
...
<div class="container" id="sales-products">
    <div style="margin-top: 50px;" class="col-md-12 col-md-ofst-4 text-center" id="products-title">
...
if (isset($_POST['search'])) {
  ...
  $query =$db->query("SELECT * FROM products WHERE name LIKE '%$searchq%'") or die(mysql_error());
		...
		if($query->num_rows > 0){
		        ...
		        <?php } }else{ ?>
		        <h2 style="padding: 50px; text-align: center; text-transform: uppercase;" >Product(s) not found.....</h2>
